...
<head>
    ...
    <style>
        ...
        .filter-container {
            ...
            position: relative;
            /* Supaya konten bisa diatur posisi absolut */
            cursor: pointer;
        }
        ...
        .filter-content {
            ...
            position: absolute;
            top: 100%;
            /* Posisi di bawah filter-container */
            left: 0;
            width: 100%;
            background-color: #f9f9f9;
            border: 1px solid #ddd;
                            ...
                            <div class="card-body p-0">
                                <div class="text-center pt-4 pb-3">
                                    <div class="avatar avatar-xl ">
                                        <!-- profile dropdown -->
                                        <img class="rounded-circle " src="<?= base_url('assets/'); ?>images/profile.jpg"
                                            alt="">
                                    </div>
    ...
    <div class="content">
                ...
                <div class="d-flex justify-content-between mb-3 align-items-center">
                    ...
                    <div class="scrollbar overflow-hidden-y">
                        <div class="btn-group position-static" role="group">
                            <!-- filter category -->
                            <select class="form-select position-static text-nowrap" id="categoryFilter" name="category"
                            ...
                            <!-- filter status -->
                            <select class="form-select position-static text-nowrap" id="statusFilter"
                                onchange="applyFilter()" style="margin-left: 5px;">
        ...
        <script>
            ...
            function applyFilter() {
                ...
                $.ajax({
                    url: "<?= base_url('index.php/UserController/filter_ajax2'); ?>", // URL endpoint AJAX
                    type: "POST",
                    data: {
                        category: category,
                        status: status
