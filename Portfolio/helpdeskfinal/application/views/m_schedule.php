...
$sqlSchedule = 'SELECT * FROM M_SCHEDULE JOIN M_USER ON M_SCHEDULE.ID_USER = M_USER.ID_USER ORDER BY ID_SCHEDULE';
    ...
    <div class="content">
        <div class="">
            ...
            <div id="tableExample3"
                data-list='{"valueNames":["id_schedule","date","technician_name"],"page":10,"pagination":true}'>
